function doPost(e) {
  try {
    ...
    var subject = isEs
      ? 'Tus Resultados de DreamFinder'
      : 'Your DreamFinder Results';
    var senderName = isEs
      ? 'Equipo de Descanso'
      : 'Sleep Team';
    ...
    try {
      ...
      var plainBody = isEs
        ? ('Hola ' + firstName + ',\n\n'
          ...
          + 'Muestra este correo para canjearlo.\n\n'
        ...
        : ('Hi ' + firstName + ',\n\n'
          ...
          + 'Show this email at the store to redeem.\n\n'
...
function buildSimpleHtml(data, firstName, isEs) {
  ...
  var headerText = isEs ? 'DreamFinder' : 'DreamFinder';
  ...
  var footerLine1 = isEs ? 'Lleva este correo a tu tienda' : 'Bring this email to your store';
