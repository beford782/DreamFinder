...
instructions = [
    ...
    ("", ""),
    ("IMAGE REQUIREMENTS:", ""),
    ("  Mattresses:  600×400px recommended, PNG or JPG, transparent background preferred", ""),
    ("  Accessories: 400×300px recommended, PNG, JPG, or WebP", ""),
    ("  Logo:        Min 400px wide, transparent background (PNG)", ""),
    ("  PWA Icons:   Exactly 192×192 and 512×512 pixels, square, PNG", ""),
    ("", ""),
    ("TIPS:", ""),
