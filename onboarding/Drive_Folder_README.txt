...
----------------
  ...
  mattresses/
      [id].png              One file per mattress, named to match the ID column
                            Example: athena.png, royal-cloud.png

  accessories/
      [id].jpg              One file per accessory, named to match the ID column
                            Example: base-bt3000.jpg, pillow-activecool.webp

IMAGE SPECIFICATIONS
--------------------
  Mattresses:   600 x 400 px recommended  |  PNG or JPG  |  Transparent background preferred
  Accessories:  400 x 300 px recommended  |  PNG, JPG, or WebP
  Store Logo:   Min 400px wide            |  PNG with transparent background
  PWA Icons:    Exactly 192x192 / 512x512 |  PNG, square, no transparency
...
----
  ...
  - Compress images before uploading (tinypng.com is free) to keep app load times fast
